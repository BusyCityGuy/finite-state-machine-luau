...
Also in the future, this project will be published on [Wally](https://wally.run/), and could be installed into your project by adding `StateQ = "busycityguy/stateq@0.0.1"` to your `wally.toml` file.
